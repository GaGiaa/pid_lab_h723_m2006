...
TARGET_RELATIVE_PATHS = (
    Path("App/Inc/driver/vofa_justfloat.h"),
    Path("App/Src/driver/vofa_justfloat.c"),
    Path("tests/vofa_justfloat_test.c"),
    Path("App/Inc/task/vofa_timestamp_task.h"),
    Path("App/Src/task/vofa_timestamp_task.c"),
    Path("App/Inc/task/m2006_control_task.h"),
    Path("App/Src/task/m2006_control_task.c"),
    Path("App/Inc/driver/m2006_hal.h"),
    Path("App/Src/driver/m2006_hal.c"),
    Path("Lib/m2006_lib/include/m2006_protocol.h"),
    Path("Lib/m2006_lib/src/m2006_protocol.c"),
    Path("Lib/m2006_lib/include/m2006_motor.h"),
    Path("Lib/m2006_lib/src/m2006_motor.c"),
    Path("Lib/m2006_lib/include/m2006_bus.h"),
    Path("Lib/m2006_lib/src/m2006_bus.c"),
    Path("Lib/m2006_lib/tests/m2006_protocol_test.c"),
    Path("Lib/m2006_lib/tests/m2006_motor_test.c"),
    Path("Lib/m2006_lib/tests/m2006_bus_test.c"),
